...
public class StrippingFactorBean extends UserAudBean implements Serializable {

	private static final long serialVersionUID = -5255211382691787452L;

	private BigDecimal idn_stripping_factor;
	...
	public StrippingFactorBean() {

		super();
		this.idn_stripping_factor = null;
		this.idn_zone = null;
		this.zone_code = null;
		this.zone_desc = null;
		this.sF = null;
	...
	public StrippingFactorBean(BigDecimal idn_stripping_factor, BigDecimal idn_zone, String zone_code, String zone_desc,
			BigDecimal sF, Date startDate, Date endDate) {
		super();
		this.idn_stripping_factor = idn_stripping_factor;
	...
	public BigDecimal getIdn_stripping_factor() {
		return idn_stripping_factor;
	}

	public void setIdn_stripping_factor(BigDecimal idn_stripping_factor) {
		this.idn_stripping_factor = idn_stripping_factor;
	}
	...
	public String toString() {
		return "StrippingFactor [idn_zone=" + idn_zone + ", sF=" + sF + ", startDate=" + startDate + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((idn_stripping_factor == null) ? 0 : idn_stripping_factor.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StrippingFactorBean other = (StrippingFactorBean) obj;
		if (endDate == null) {
			if (other.endDate != null)
				return false;
		} else if (!endDate.equals(other.endDate))
			return false;
		if (idn_stripping_factor == null) {
			if (other.idn_stripping_factor != null)
				return false;
		} else if (!idn_stripping_factor.equals(other.idn_stripping_factor))
			return false;
		if (idn_zone == null) {

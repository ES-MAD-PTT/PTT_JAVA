...
public class SystemParameterDamBean extends UserAudBean implements Serializable {
	...
	public SystemParameterDamBean() {
		super();
	}

	public SystemParameterDamBean(BigDecimal idn_parameter, BigDecimal idn_parameter_value, String parameter_desc,
	...
	public String toString() {
		return "SystemParameterDamBean [idn_parameter=" + idn_parameter + ", idn_parameter_value=" + idn_parameter_value
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SystemParameterDamBean other = (SystemParameterDamBean) obj;
		if (endDate == null) {

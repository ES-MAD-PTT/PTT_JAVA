...
public class StrippingFactorFilter implements Serializable{
	...
	public String toString() {
		return "StrippingFactorFilter [zone=" + zone + ", startDate=" + startDate + ", endDate=" + endDate

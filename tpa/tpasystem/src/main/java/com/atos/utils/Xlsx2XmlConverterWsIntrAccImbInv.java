...
public class Xlsx2XmlConverterWsIntrAccImbInv implements Serializable {
	...
	private static final Logger log = LogManager.getLogger("com.atos.utils.Xlsx2XmlConverterWsIntrAccImbInv");
	...
	public Xlsx2XmlConverterWsIntrAccImbInv() {
		super();
	}
	...
	public void init( String _catCode, String _termCode, String _fileType, BigDecimal _systemId ) throws Exception {
		...
		try {
			...
			WsTemplateBean otbXLSTemplate = null;

			String ws = "ACUM.INVENTORY";
			List<WsTemplateBean> lotbSalida = xMapper.getWsTemplateFiletypeSystem(ws);

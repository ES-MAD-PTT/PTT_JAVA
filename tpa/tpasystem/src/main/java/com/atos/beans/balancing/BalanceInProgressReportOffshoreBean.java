...
public class BalanceInProgressReportOffshoreBean implements Serializable {
		
	/**
	 * 
	 */
	private static final long serialVersionUID = 7205728411727525781L;
	...
	public BalanceInProgressReportOffshoreBean() {
	...
	public String toString() {
		return "BalanceInProgressReportOffshoreBean [sdf=" + sdf + ", gasDay=" + gasDay + ", shipperCode=" + shipperCode

...
import com.atos.services.balancing.BalanceInProgressReportService;
import com.atos.utils.Constants;
import com.atos.views.CommonView;

@ManagedBean(name="balInProgressReportView")
@ViewScoped
public class BalanceInProgressReportView extends CommonView {
	...
	private BalanceInProgressReportFilter filters;
	private List<BalanceInProgressReportBean> items;
	private List<BalanceInProgressReportOffshoreBean> itemsOffshore;
	private BalanceInProgressReportBean selected;
	private BalanceInProgressReportOffshoreBean selectedOffshore;

	private static final Logger log = LogManager.getLogger("com.atos.views.balancing.BalanceInProgressReportView");

	@ManagedProperty("#{BalanceInProgressReportService}")
    transient private BalanceInProgressReportService service;
    
	public void setService(BalanceInProgressReportService service) {
		this.service = service;
	}
	
	//geters/seters
	public BalanceInProgressReportFilter getFilters() {
		return filters;
	}

	public void setFilters(BalanceInProgressReportFilter filters) {
		this.filters = filters;
	}

	public List<BalanceInProgressReportBean> getItems() {
		return items;
	}

	public void setItems(List<BalanceInProgressReportBean> items) {
		this.items = items;
	}
	
	public List<BalanceInProgressReportOffshoreBean> getItemsOffshore() {
		return itemsOffshore;
	}

	public void setItemsOffshore(List<BalanceInProgressReportOffshoreBean> itemsOffshore) {
		this.itemsOffshore = itemsOffshore;
	}

	public BalanceInProgressReportBean getSelected() {
		return selected;
	}

	public void setSelected(BalanceInProgressReportBean selected) {
		this.selected = selected;
	}

	public BalanceInProgressReportOffshoreBean getSelectedOffshore() {
		return selectedOffshore;
	}

	public void setSelectedOffshore(BalanceInProgressReportOffshoreBean selectedOffshore) {
    ...
    public void init() {
        ...
        selected = new BalanceInProgressReportBean();
        selectedOffshore = new BalanceInProgressReportOffshoreBean();
	}
	
	private BalanceInProgressReportFilter initFilter(){
		BalanceInProgressReportFilter tmpFilter = new BalanceInProgressReportFilter();
		...
		tmpFilter.setGasDay(tmpYesterday.getTime());
		return tmpFilter;
	}

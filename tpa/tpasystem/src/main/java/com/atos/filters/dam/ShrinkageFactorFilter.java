...
public class ShrinkageFactorFilter implements Serializable{
	...
	public String toString() {
		return "ShrinkageFactorFilter [zone=" + zone + ", startDate=" + startDate + ", endDate=" + endDate

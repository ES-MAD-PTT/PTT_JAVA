...
public class TariffChargeDetailBean extends UserAudBean implements Serializable{
	...
	public String toString() {
		return "TariffChargeDetailBean [detailGasDay=" + detailGasDay + ", dailyBookedEntryCapacity="
				+ dailyBookedEntryCapacity + ", dailyCapacityCharge=" + dailyCapacityCharge
				+ ", dailyAllocatedExitValue=" + dailyAllocatedExitValue + ", dailyAllocatedEntryValue="
				+ dailyAllocatedEntryValue + ", dailyCommodityCharge=" + dailyCommodityCharge
				+ ", dailyEntryCapacityOU=" + dailyEntryCapacityOU + ", dailyOriginalEntryCapacityOU="
				+ dailyOriginalEntryCapacityOU + ", dailyReducedEntryCapacityOU=" + dailyReducedEntryCapacityOU
				+ ", dailyEntryCapacityOUCharge=" + dailyEntryCapacityOUCharge + ", dailyExitCapacityOU="
				+ dailyExitCapacityOU + ", dailyOriginalExitCapacityOU=" + dailyOriginalExitCapacityOU
				+ ", dailyReducedExitCapacityOU=" + dailyReducedExitCapacityOU + ", dailyExitCapacityOUCharge="
				+ dailyExitCapacityOUCharge + ", dailyOriginalImbalance=" + dailyOriginalImbalance + ", dailyImbalance="
				+ dailyImbalance + ", dailyImbalanceCharge=" + dailyImbalanceCharge + "]";
	}

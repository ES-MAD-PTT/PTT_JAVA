...
public class BalanceIntradayReportOffshoreBean implements Serializable {
	...
	public BalanceIntradayReportOffshoreBean() {
	...
	public String toString() {
		return "BalanceIntradayReportOffshoreBean [sdf=" + sdf + ", gasDay=" + gasDay + ", shipperCode=" + shipperCode

...
public class ContractDeadlineSpecialFilter implements Serializable{
	...
	public ContractDeadlineSpecialFilter() {
	...
	public String toString() {
		return "ContractDeadlineSpecialFilter [submissionManagement=" + submissionManagement + ", type=" + type

...
public class BalanceIntradayReportBean implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1412374798085671098L;
	...
	private String eAccImbalanceColor;
	private BigDecimal wAccImbalance;
	private String wAccImbalanceColor;
	...
	private BigDecimal eACCImbInvPtt;
	private String eACCImbInvPttColor;
	private BigDecimal wACCImbInvPtt;
	private String wACCImbInvPttColor;
	private BigDecimal bvw10East;
	private BigDecimal bvw10West;
	...
	private BigDecimal flag_nomination;
	
	public BalanceIntradayReportBean() {
		...
		this.eAccImbalanceColor = null;
		this.wAccImbalance = null;
		this.wAccImbalanceColor = null;
		...
		this.eACCImbInvPtt=null;
		this.wACCImbInvPtt=null;
		this.eACCImbInvPttColor=null;
		this.wACCImbInvPttColor=null;
		this.bvw10East=null;
		this.bvw10West=null;
	...
	public String geteAccImbalanceColor() {
		return eAccImbalanceColor;
	}

	public void seteAccImbalanceColor(String eAccImbalanceColor) {
		this.eAccImbalanceColor = eAccImbalanceColor;
	}
	...
	public String getwAccImbalanceColor() {
		return wAccImbalanceColor;
	}

	public void setwAccImbalanceColor(String wAccImbalanceColor) {
		this.wAccImbalanceColor = wAccImbalanceColor;
	}
	...
	public BigDecimal getFlag_nomination() {
		return flag_nomination;
	}

	public void setFlag_nomination(BigDecimal flag_nomination) {
		this.flag_nomination = flag_nomination;
	}

	public BigDecimal geteACCImbInvPtt() {
		return eACCImbInvPtt;
	}

	public void seteACCImbInvPtt(BigDecimal eACCImbInvPtt) {
		this.eACCImbInvPtt = eACCImbInvPtt;
	}

	public BigDecimal getwACCImbInvPtt() {
		return wACCImbInvPtt;
	}

	public void setwACCImbInvPtt(BigDecimal wACCImbInvPtt) {
		this.wACCImbInvPtt = wACCImbInvPtt;
	}

	public String geteACCImbInvPttColor() {
		return eACCImbInvPttColor;
	}

	public void seteACCImbInvPttColor(String eACCImbInvPttColor) {
		this.eACCImbInvPttColor = eACCImbInvPttColor;
	}

	public String getwACCImbInvPttColor() {
		return wACCImbInvPttColor;
	}

	public void setwACCImbInvPttColor(String wACCImbInvPttColor) {
		this.wACCImbInvPttColor = wACCImbInvPttColor;
	}

	public BigDecimal getBvw10East() {
		return bvw10East;
	}

	public void setBvw10East(BigDecimal bvw10East) {
		this.bvw10East = bvw10East;
	}

	public BigDecimal getBvw10West() {
		return bvw10West;
	}

	public void setBvw10West(BigDecimal bvw10West) {
		this.bvw10West = bvw10West;
	}
	...
	public String toCSVHeader() {
		...
		builder.append(
				"versionDate;shipperCode;shipperName;shortName;contractCode;eTotalEntry;wTotalEntry;ewTotalEntry;eTotalExit;wTotalExit;ewTotalExit;eImbalanceZone;wImbalanceZone;totalImbalanceZone;eInstructedFlow;wInstructedFlow;eShrinkageQuantity;wShrinkageQuantity;ePark;wPark;eUnpark;wUnpark;eSOTDPark;wSOTDPark;eEOTDPark;wEOTDPark;eMinInventory;wMinInventory;eResBalancingGas;wResBalancingGas;eMonthAdjust;wMonthAdjust;eImbalanceStock;wImbalanceStock;totalAIP;totalAIN;imbalancePercentage;eAccImbalanceMonth;wAccImbalanceMonth;eAccImbalance;wAccImbalance;eACCImbInvPtt;wACCImbInvPtt;eUsedCapacity;wUsedCapacity;GSP;BYPASS;LNG;YDN;YTG;ZTK;eFrom;wFrom;eBvw10;wBvw10;eEGAT;eIPP;e_others;wEGAT;wIPP;w_others;ewEGAT;ewIPP;ew_others;eF2g;wF2g;e_east;e_west");
	...
	public String toCSV() {
		...
		builder.append((eACCImbInvPtt==null ? "" : eACCImbInvPtt.toPlainString()) +";");
		builder.append((wACCImbInvPtt==null ? "" : wACCImbInvPtt.toPlainString()) +";");
		...
		builder.append((bvw10East==null ? "" : bvw10East.toPlainString()) +";");
		builder.append((bvw10West==null ? "" : bvw10West.toPlainString()) +";");
	...
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("BalanceIntradayReportBean [sdf=");
		builder.append(sdf);
		...
		builder.append(eAccImbalance);
		builder.append(", eAccImbalanceColor=");
		builder.append(eAccImbalanceColor);
		builder.append(", wAccImbalanceColor=");
		builder.append(wAccImbalanceColor);
		...
		builder.append(ew_others);
		builder.append(", eACCImbInvPtt=");
		builder.append(eACCImbInvPtt);
		builder.append(", wACCImbInvPtt=");
		builder.append(wACCImbInvPtt);
		builder.append(", eACCImbInvPttColor=");
		builder.append(eACCImbInvPttColor);
		builder.append(", wACCImbInvPttColor=");
		builder.append(wACCImbInvPttColor);
		builder.append(", bvw10East=");
		builder.append(bvw10East);
		builder.append(", bvw10West=");
		builder.append(bvw10West);
		builder.append(", eF2g=");
		builder.append(eF2g);
		builder.append(", wF2g=");
		...
		builder.append(e_west);
		builder.append(", flag_nomination=");
		builder.append(flag_nomination);
		builder.append("]");
		return builder.toString();
	}

...
public class NominationBean extends UserAudBean implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NominationBean other = (NominationBean) obj;
		if (end_date == null) {
	...
	public String toString() {
		return "NominationBean [idn_nomination=" + idn_nomination + ", nomination_code=" + nomination_code
				+ ", nomination_version=" + nomination_version + ", idn_operation=" + idn_operation
				+ ", idn_user_group=" + idn_user_group + ", idn_contract=" + idn_contract + ", is_contracted="
				+ is_contracted + ", start_date=" + start_date + ", end_date=" + end_date + ", is_renomination="
				+ is_renomination + ", is_valid=" + is_valid + ", is_responsed=" + is_responsed + ", feasibility_date="
				+ feasibility_date + ", operator_comments=" + operator_comments + ", is_matched=" + is_matched
				+ ", matching_date=" + matching_date + ", submission_comments=" + submission_comments
				+ ", idn_shipper_file=" + idn_shipper_file + ", idn_operator_file=" + idn_operator_file + "]";
	}

...
import com.atos.services.forecasting.ForecastingLongIntermediateSubmissionFileService;
import com.atos.utils.Constants;
import com.atos.views.CommonView;

@ManagedBean(name="forecastingLongIntermediateSubmissionFileView")
@ViewScoped
public class ForecastingLongIntermediateSubmissionFileView extends CommonView {
	

	/**
	 * 
	 */
	private static final long serialVersionUID = -5766428106170310937L;

	private static final Logger log = LogManager.getLogger(ForecastingLongIntermediateSubmissionFileView.class);

	private UploadedFile file;
	private FileBean uploadFile;
	
	@ManagedProperty("#{forecastingLongIntermediateSubmissionFileService}")
    transient private ForecastingLongIntermediateSubmissionFileService service;
    
    public void setService(ForecastingLongIntermediateSubmissionFileService service) {
	...
	public void handleFileUpload(FileUploadEvent event) {
		...
		else if(error!=null && error.equalsIgnoreCase("OK")){

...
public class AdjustmentAllocationBean implements Serializable {
	...
	private BigDecimal finalImbalanceStock;
	...
	private BigDecimal imbalanceCorrection;
	...
	public BigDecimal getFinalImbalanceStock() {
		return finalImbalanceStock;
	}

	public void setFinalImbalanceStock(BigDecimal finalImbalanceStock) {
		this.finalImbalanceStock = finalImbalanceStock;
	}
	...
	public BigDecimal getImbalanceCorrection() {
		return imbalanceCorrection;
	}

	public void setImbalanceCorrection(BigDecimal imbalanceCorrection) {
		this.imbalanceCorrection = imbalanceCorrection;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((finalImbalanceStock == null) ? 0 : finalImbalanceStock.hashCode());
		...
		result = prime * result + ((imbalanceCorrection == null) ? 0 : imbalanceCorrection.hashCode());
		result = prime * result + ((imbalanceStock == null) ? 0 : imbalanceStock.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AdjustmentAllocationBean other = (AdjustmentAllocationBean) obj;
		...
		if (errorDesc == null) {
			...
			return false;
		if (finalImbalanceStock == null) {
			if (other.finalImbalanceStock != null)
				return false;
		} else if (!finalImbalanceStock.equals(other.finalImbalanceStock))
			return false;
		if (gasDay == null) {
		...
		if (idn_active_system == null) {
			...
			return false;
		if (imbalanceCorrection == null) {
			if (other.imbalanceCorrection != null)
				return false;
		} else if (!imbalanceCorrection.equals(other.imbalanceCorrection))
			return false;
		if (imbalanceStock == null) {
			if (other.imbalanceStock != null)
				return false;
		} else if (!imbalanceStock.equals(other.imbalanceStock))
			return false;
		if (isEditable == null) {

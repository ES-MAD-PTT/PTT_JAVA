...
public class NominationPointFilter implements Serializable{
	...
	public String toString() {
		return "NominationPointFilter [id=" + id + ", pointType=" + pointType + ", systemCode=" + systemCode + ", zone="
